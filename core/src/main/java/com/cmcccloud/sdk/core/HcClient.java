/*
 * Copyright (c) CMCC Technologies Co., Ltd. 2021-2021. All rights reserved.
 *
...
package com.cmcccloud.sdk.core;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.cmcccloud.sdk.core.auth.ICredential;
import com.cmcccloud.sdk.core.exception.DefaultExceptionHandler;
import com.cmcccloud.sdk.core.exception.ExceptionHandler;
import com.cmcccloud.sdk.core.exception.HostUnreachableException;
import com.cmcccloud.sdk.core.exception.SdkException;
import com.cmcccloud.sdk.core.exception.ServerResponseException;
import com.cmcccloud.sdk.core.exception.ServiceResponseException;
import com.cmcccloud.sdk.core.exchange.ApiReference;
import com.cmcccloud.sdk.core.exchange.SdkExchange;
import com.cmcccloud.sdk.core.exchange.SdkExchangeCache;
import com.cmcccloud.sdk.core.http.Field;
import com.cmcccloud.sdk.core.http.HttpClient;
import com.cmcccloud.sdk.core.http.HttpConfig;
...
import com.cmcccloud.sdk.core.http.SdkFormDataBody;
import com.cmcccloud.sdk.core.impl.DefaultHttpClient;
import com.cmcccloud.sdk.core.progress.ProgressInputStream;
import com.cmcccloud.sdk.core.progress.ProgressRequest;
import com.cmcccloud.sdk.core.progress.SimpleProgressManager;
import com.cmcccloud.sdk.core.utils.CastUtils;
import com.cmcccloud.sdk.core.utils.ExceptionUtils;
import com.cmcccloud.sdk.core.utils.HttpUtils;
import com.cmcccloud.sdk.core.utils.JsonUtils;
...
import static com.cmcccloud.sdk.core.Constants.SDK_EXCHANGE;

/**
 * @author CMCCCloud_SDK
 */
public class HcClient implements CustomizationConfigure {
    ...
    public static class AccessLog {
        private static final Logger logger = LoggerFactory.getLogger("CMCCCloud-SDK-Access");
    ...
    protected <R, S> HttpRequest buildRequest(R request, HttpRequestDef<R, S> reqDef) {
        ...
        httpRequestBuilder.addHeader(Constants.USER_AGENT, "cmcccloud-usdk-java/3.0");
