...
public final class Constants {
    ...
    public static final String DEFAULT_IAM_ENDPOINT = "https://iam.cidc-rp-11.joint.cmecloud.cn";

    public static final String IAM_ENDPOINT_ENV_NAME = "CMCCCLOUD_SDK_IAM_ENDPOINT";
    ...
    public static final String DEFAULT_PROFILE_DIR_NAME = ".cmcccloud";
